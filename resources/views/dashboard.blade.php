    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            <div class="flex">
                ...
                <div class="flex-auto text-2xl mb-4"><p>Date & Time: <span id="datetime"></span></p> </div>
                    ...
                    <tr class="border-b hover:bg-orange-100">
                        ...
                        <td class="p-3 px-5">
                            ...
                            <form action="/task/{{$task->id}}" class="inline-block">
                                <button type="submit" name="delete" formmethod="POST" class="text-sm bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Done</button>
                                {{ csrf_field() }}
                            </form>
                        </td>
                        <td class="p-3 px-5">
